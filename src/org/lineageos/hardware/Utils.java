...
class Utils {
    public static DisplayMode[] HIDLModeListToArray(ArrayList<vendor.lineage.livedisplay.V1_0.DisplayMode> modes) {
        int size = modes.size();
    ...
    public static HSIC fromHIDLHSIC(vendor.lineage.livedisplay.V1_0.HSIC hsic) {
        return new HSIC((float) hsic.hue, hsic.saturation, hsic.intensity, hsic.contrast, hsic.saturationThreshold);
    }
